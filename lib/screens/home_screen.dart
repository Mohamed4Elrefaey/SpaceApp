...
import 'package:space/widgets/pageView.dart';
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  Image.asset(AssetsManager.headerPhoto),
                  Container(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    planets[currentIndex].planetName,
                    style: TextStyle(
                      color: ColorManager.onPrimary,
                      fontSize: 24,
                      fontWeight: FontWeight.w700,
